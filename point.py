...
def add_point(offset_x, offset_y):
    points=[
        ...
        Point(341+offset_x,69+offset_y,5,RED,'GORYCZKOWA PRZEŁĘCZ'),                             # GORYCZKOWA PRZEŁĘCZ
        ...
        Point(1360+700+offset_x,439+600+offset_y,5,RED,'DROGA CZERWONEGO SZLAKU Z MORSKIEGO OKA'),      # DROGA CZERWONEGO SZLAKU Z MORSKIEGO OKA
        ...
        Point(1022+500+offset_x,152+offset_y,5,RED,'KOŁOWA CZUBA'),          # ORLA PERĆ
        ...
        Point(731+offset_x,11+offset_y,5,GREEN,'SZ1'),
        Point(726+offset_x,34+offset_y,5,GREEN,'SZ1'),
        Point(728+offset_x,66+offset_y,5,GREEN,'SZ1'),
        Point(725+offset_x,86+offset_y,5,GREEN,'SZ1'),
        Point(723+offset_x,102+offset_y,5,GREEN,'SZ1'),
        Point(718+offset_x,126+offset_y,5,GREEN,'SZ1'),
        Point(730+offset_x,154+offset_y,5,GREEN,'SZ1'),
        Point(731+offset_x,200+offset_y,5,GREEN,'SZ1'),

        #SZLAK CZARNY NA WSCHOD OD KASPROWEGO
        Point(829+offset_x,70+offset_y,5,BLACK,'SCZ1'),
        Point(863+offset_x,84+offset_y,5,BLACK,'SCZ1'),
        Point(886+offset_x,115+offset_y,5,BLACK,'SCZ1'),
        Point(909+offset_x,137+offset_y,5,BLACK,'SCZ1'),
        Point(923+offset_x,159+offset_y,5,BLACK,'SCZ1'),
        Point(942+offset_x,180+offset_y,5,BLACK,'SCZ1'),
        Point(956+offset_x,236+offset_y,5,BLACK,'SCZ1'),
        Point(921+offset_x,270+offset_y,5,BLACK,'SCZ1'),
        
        #SZLAK NIEBIESKI NA WSCHOD OD KASPROWEGO

        Point(936+offset_x,124+offset_y,5,BLUE,'SNB1'),
        Point(981+offset_x,108+offset_y,5,BLUE,'SNB1'),
        Point(1008+offset_x,117+offset_y,5,BLUE,'SNB1'),
        Point(1062+offset_x,108+offset_y,5,BLUE,'SNB1'),
        
        #SZLAK CZARNY NA WSCHOD OD KASPROWEGO, DOJSCIE DO KOŚCIELCA I CZARNEGO STAWU

        Point(1078+offset_x,133+offset_y,5,BLACK,'SCZ2'),
        Point(1089+offset_x,182+offset_y,5,BLACK,'SCZ2'),
        Point(1048+offset_x,63+offset_y,5,BLACK,'SCZ2'),
        Point(1073+offset_x,40+offset_y,5,BLACK,'SCZ2'),
        Point(1107+offset_x,9+offset_y,5,BLACK,'SCZ2'),
